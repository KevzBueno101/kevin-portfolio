    ...
    <div className="bg-white dark:bg-fb-dark border-b border-gray-200 dark:border-fb-darkborder px-4">
      <div className="flex items-end gap-4 pb-3 -mt-10">
        ...
        >
          ...
          <p className="text-fb-blue font-medium text-sm mt-0.5">
        ...
        >
          {[
            { Icon: GithubIcon, href: 'https://github.com/KevzBueno101' },
            { Icon: GlobeIcon, href: 'https://www.facebook.com/kevin.b.bueno.5' },
            { Icon: LinkedinIcon, href: 'https://www.linkedin.com/in/kevin-bueno-922174375' },
            { Icon: MailIcon, href: 'mailto:kevinbueno360@gmail.com' },
          ].map(({ Icon, href }, i) => (
            <a key={i} href={href} target="_blank" rel="noreferrer"
              className="p-2 rounded-full bg-gray-100 dark:bg-fb-darkcard hover:bg-gray-200 dark:hover:bg-fb-darkhover transition text-gray-600 dark:text-gray-300">
              <Icon />
            </a>
          ))}
        </motion.div>
